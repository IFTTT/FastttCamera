...
SpecBegin(FastttFilterCamera)

describe(@"FastttFilterCamera", ^{
    __block FastttFilterCamera *fastCamera;
    __block id delegate;
    
    beforeAll(^{
        // This is run once and only once before all of the examples
        // in this group and before any beforeEach blocks.
        fastCamera = [FastttFilterCamera cameraWithFilterImage:[UIImage imageNamed:@"RetroFilter"]];
        [fastCamera loadView];
