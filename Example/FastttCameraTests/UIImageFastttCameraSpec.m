...
describe(@"UIImageFastttCamera", ^{
    ...
    describe(@"Image Output Rect Cropping", ^{
        ...
        beforeAll(^{
            ...
            croppedImage = [image fastttCroppedToOutputRect:outputRect];
            croppedRightImage = [rightImage fastttCroppedToOutputRect:outputRect];
            croppedMirroredImage = [mirroredImage fastttCroppedToOutputRect:outputRect];
        });
    ...
    describe(@"Image Crop Rect Cropping", ^{
        ...
        beforeAll(^{
            ...
            croppedImage = [image fastttCroppedToRect:cropRect];
            croppedRightImage = [rightImage fastttCroppedToRect:cropRect];
            croppedMirroredImage = [mirroredImage fastttCroppedToRect:cropRect];
        });
    ...
    describe(@"Image Scale To Size", ^{
        ...
        beforeAll(^{
            ...
            scaledImage = [image fastttScaledToSize:scaledSize];
            scaledRightImage = [rightImage fastttScaledToSize:scaledSize];
            scaledMirroredImage = [mirroredImage fastttScaledToSize:scaledSize];
        });
    ...
    describe(@"Image Scale To Max Dimension", ^{
        ...
        beforeAll(^{
            ...
            scaledImage = [image fastttScaledToMaxDimension:maxDimension];
            scaledRightImage = [rightImage fastttScaledToMaxDimension:maxDimension];
            scaledMirroredImage = [mirroredImage fastttScaledToMaxDimension:maxDimension];
            scaledTallImage = [UIImage imageNamed:@"FastttCameraTestRight.png"];
            scaledTallImage = [scaledTallImage fastttScaledToMaxDimension:maxDimension];
    ...
    describe(@"Image Scale To Scale", ^{
        ...
        beforeAll(^{
            ...
            scaledImage = [image fastttScaledToScale:scale];
            scaledRightImage = [rightImage fastttScaledToScale:scale];
            scaledMirroredImage = [mirroredImage fastttScaledToScale:scale];
        });
    ...
    describe(@"Image Normalize Orientation", ^{
        ...
        beforeAll(^{
            // This is run before each example
            normalizedImage = [image fastttNormalizeOrientation];
            normalizedRightImage = [rightImage fastttNormalizeOrientation];
            normalizedMirroredImage = [mirroredImage fastttNormalizeOrientation];
        });
    ...
    describe(@"Image Rotate to match camera view", ^{
        ...
        beforeAll(^{
            // This is run before each example
            rotatedImage = [image fastttRotatedToMatchCameraView];
            rotatedRightImage = [rightImage fastttRotatedToMatchCameraView];
            rotatedMirroredImage = [mirroredImage fastttRotatedToMatchCameraView];
        });
